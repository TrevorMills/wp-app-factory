...
Ext.define('Ext.viewport.Android', {
    ...
    doFireOrientationChangeEvent: function() {
        ...
        this.waitUntil(function() {
            ...
            //<debug error> // TMILLS - changed this from Ext.Logger.error to .warn
            Ext.Logger.warn("Timeout waiting for viewport's outerHeight to change before firing orientationchange", this);
            //</debug>
        });

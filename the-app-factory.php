...
function the_app_factory_install() {
	...
	if (is_multisite()){
		...
		$insertion = array(
			...
			'RewriteRule ^('.$root_site_prefix.')?([^\/]*)/?apps/[^\/]+/sdk/(.*)$ '.$site_root.'$2/wp-content/plugins/wp-app-factory/the-app/sdk/$3 [L]',
		...
		$insertion = array(
			...
			'RewriteRule ^apps/[^\/]+/sdk/(.*)$ '.$site_root.'wp-content/plugins/wp-app-factory/the-app/sdk/$1 [L]',
